...
public class HBaseSailSplTest {
	...
	private void insertSchema(RepositoryConnection target) throws RDFParseException, RepositoryException, IOException {
		String[] schemas = { "/schema/owl-basic.ttl", "/schema/sp.ttl", "/schema/spif.ttl", "/schema/spin.ttl", "/schema/spl.spin.ttl" };
