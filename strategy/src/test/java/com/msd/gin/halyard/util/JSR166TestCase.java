...
//     }
    ...
    public static class NoOpCallable implements Callable<Boolean> {
...
//     }
    ...
    public class SmallCallable extends CheckedCallable<Boolean> {
        protected Boolean realCall() throws InterruptedException {
            delay(SMALL_DELAY_MS);
            return Boolean.TRUE;
        }
    }
    ...
    public static class TrackedCallable implements Callable<Boolean> {
        public volatile boolean done = false;
        public Boolean call() {
            try {
                delay(SMALL_DELAY_MS);
