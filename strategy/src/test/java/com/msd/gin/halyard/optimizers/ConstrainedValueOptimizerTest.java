...
public class ConstrainedValueOptimizerTest extends AbstractOptimizerTest {
	...
	public void testMultipleStatements() {
		...
		ConstrainedStatementPattern csp = new ConstrainedStatementPattern(StatementPattern.Scope.DEFAULT_CONTEXTS, new Var("s"), new Var("p"), new Var("x"), null, StatementIndex.Name.SPO, RDFRole.Name.SUBJECT, VarConstraint.partitionConstraint(2));
	...
	public void testMultiplePartitioning() {
		...
		ConstrainedStatementPattern csp = new ConstrainedStatementPattern(StatementPattern.Scope.DEFAULT_CONTEXTS, new Var("s"), new Var("p"), new Var("o"), null, StatementIndex.Name.OSP, RDFRole.Name.OBJECT, VarConstraint.partitionConstraint(2));
	...
	public void testFromDataset() {
		...
		ConstrainedStatementPattern csp = new ConstrainedStatementPattern(StatementPattern.Scope.DEFAULT_CONTEXTS, new Var("s"), new Var("p"), new Var("o"), null, StatementIndex.Name.CPOS, RDFRole.Name.PREDICATE, VarConstraint.partitionConstraint(2));
		TupleExpr where = csp;
		TupleExpr expected = new QueryRoot(
				new Projection(where, new ProjectionElemList(new ProjectionElem("s"))));
		testOptimizer(expected, q);
