...
public class UpdateExprBuilder extends TupleExprBuilder {
	...
	public TupleExpr visit(ASTTripleRef node, Object data) throws VisitorException {
		...
		ret.setExprVar(createTripleRefAnonVar(ret));
	...
	protected Var createTripleRefAnonVar(TripleRef tf) {
		return new Var("_tripleref_" + Integer.toHexString(tf.hashCode()) + "_" + ++tripleRefVarCount, true);
	}
}
