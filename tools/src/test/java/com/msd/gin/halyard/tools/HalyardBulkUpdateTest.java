...
public class HalyardBulkUpdateTest extends AbstractHalyardToolTest {
    ...
    public void testSingleBulkUpdate() throws Exception {
        ...
        assertEquals(0, run(new String[]{ "--update-operation", query, "-w", htableDir.toURI().toURL().toString(), "-s", table}));
    ...
    public void testSingleBulkUpdateWithBinding() throws Exception {
        ...
        assertEquals(0, run(new String[]{ "--update-operation", query, "-w", htableDir.toURI().toURL().toString(), "-s", table, "-$arg=\"foobar\""}));
