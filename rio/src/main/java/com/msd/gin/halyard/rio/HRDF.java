...
public final class HRDF {
	public static final RDFFormat FORMAT = new RDFFormat("HRDF", "application/x-hrdf", null, "hrdf", RDFFormat.NO_NAMESPACES, RDFFormat.SUPPORTS_CONTEXTS, RDFFormat.SUPPORTS_RDF_STAR);
